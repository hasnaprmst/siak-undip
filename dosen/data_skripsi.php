...
<html>
  ...
  <body>
    ...
    <div class="flex flex-col max-w-4xl mx-auto mt-16">
      <!-- Content -->
      <h1 class="text-center text-2xl">Rekap Mahasiswa Skripsi</h1><br></br>
  ...
  $query = "SELECT angkatan, COUNT(nim) as jml FROM skripsi GROUP BY angkatan";
