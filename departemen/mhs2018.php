...
<br>
    ...
    <!-- End of Navbar -->
    <div class="">
      <h1 class="text-4xl mx-20 my-8 mt-24">Data Mahasiswa 2018</h1>
      <div class="overflow-x-auto mx-20 relative shadow-md sm:rounded-lg"><br><br>
          ...
          <table id= "table" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                ...
                WHERE angkatan = '2018' AND status = 'AKTIF' ORDER BY nim ASC";
                $result = $db->query($sql);
                $nomor = 0;
  ...
  <meta charset="UTF-8" />
   ...
   <nav>
      <div class="logo">
        ...
        <span class="logo-name">Data Mahasiswa 2018</span>
      </div>
      <div class="sidebar">
        <div class="logo">
          <i class="bx bx-menu menu-icon"></i>
